...
export const USERS: User[] = [
  { id: '1', name: 'Harikrishnan P S', email: 'harikrishnan@ariesmarine', password: 'password', role: 'Admin', avatar: 'https://i.pravatar.cc/150?u=1' },
  { id: '2', name: 'Manu M G', email: 'manu@ariesmarine', password: 'password', role: 'Manager', avatar: 'https://i.pravatar.cc/150?u=2', supervisorId: '1' },
  { id: '3', name: 'Mujeeb', email: 'mujeeb@ariesmarine', password: 'password', role: 'Supervisor', avatar: 'https://i.pravatar.cc/150?u=3', supervisorId: '2' },
  { id: '4', name: 'Albin Raju', email: 'albin@ariesmarine', password: 'password', role: 'Supervisor', avatar: 'https://i.pravatar.cc/150?u=4', supervisorId: '2' },
  { id: '5', name: 'Arjun P', email: 'arjun@ariesmarine', password: 'password', role: 'Supervisor', avatar: 'https://i.pravatar.cc/150?u=5', supervisorId: '2' },
  { id: '6', name: 'Sreehari', email: 'sreehari@ariesmarine', password: 'password', role: 'Supervisor', avatar: 'https://i.pravatar.cc/150?u=6', supervisorId: '2' },
  { id: '7', name: 'Vishnu H', email: 'vishnu.h@ariesmarine', password: 'password', role: 'Supervisor', avatar: 'https://i.pravatar.cc/150?u=7', supervisorId: '2' },
  { id: '8', name: 'Akhil A', email: 'akhil.a@ariesmarine', password: 'password', role: 'Supervisor', avatar: 'https://i.pravatar.cc/150?u=8', supervisorId: '2' },
  { id: '9', name: 'Dhaneesh Kumar', email: 'dhaneesh@ariesmarine', password: 'password', role: 'Supervisor', avatar: 'https://i.pravatar.cc/150?u=9', supervisorId: '2' },
  { id: '10', name: 'Rakhil Raj', email: 'rakhil@ariesmarine', password: 'password', role: 'Supervisor', avatar: 'https://i.pravatar.cc/150?u=10', supervisorId: '2' },
  { id: '11', name: 'Akhil Pillai', email: 'akhil.pillai@ariesmarine', password: 'password', role: 'Junior Supervisor', avatar: 'https://i.pravatar.cc/150?u=11', supervisorId: '3' },
  { id: '12', name: 'Athul Kumar', email: 'athul@ariesmarine', password: 'password', role: 'Junior Supervisor', avatar: 'https://i.pravatar.cc/150?u=12', supervisorId: '3' },
  { id: '13', name: 'Rinu Sam', email: 'rinu@ariesmarine', password: 'password', role: 'Junior Supervisor', avatar: 'https://i.pravatar.cc/150?u=13', supervisorId: '4' },
  { id: '14', name: 'Syam Kumar', email: 'syam@ariesmarine', password: 'password', role: 'Junior Supervisor', avatar: 'https://i.pravatar.cc/150?u=14', supervisorId: '4' },
  { id: '15', name: 'Vishnu S', email: 'vishnu.s@ariesmarine', password: 'password', role: 'Junior Supervisor', avatar: 'https://i.pravatar.cc/150?u=15', supervisorId: '5' },
  { id: '16', name: 'Vishnu J', email: 'vishnu.j@ariesmarine', password: 'password', role: 'Junior Supervisor', avatar: 'https://i.pravatar.cc/150?u=16', supervisorId: '5' },
  { id: '17', name: 'Amaldas M', email: 'amaldas@ariesmarine', password: 'password', role: 'Junior Supervisor', avatar: 'https://i.pravatar.cc/150?u=17', supervisorId: '6' },
  { id: '18', name: 'Sajin Soman', email: 'sajin@ariesmarine', password: 'password', role: 'Junior Supervisor', avatar: 'https://i.pravatar.cc/150?u=18', supervisorId: '6' },
  { id: '19', name: 'Aparana M R', email: 'aparana@ariesmarine', password: 'password', role: 'Team Member', avatar: 'https://i.pravatar.cc/150?u=19', supervisorId: '11' },
];
